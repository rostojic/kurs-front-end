...
const coverPhoto = document.querySelectorAll('.cover');

//console.log(coverPhoto.length);

const authorName = document.querySelectorAll('.author');

const pageNumber = document.querySelectorAll('.pages');



(function defaultSort() {
for(i = 0; i < books.length; i++) {
  coverPhoto[i].src = books[i].cover;
  authorName[i].textContent = books[i].author;
  pageNumber[i].textContent = books[i].pages;
}
...
function sortBooks() {
  var selectOpt = document.getElementById('sortBtn');
//console.log(selectOpt);
  var selected = selectOpt.options[selectOpt.selectedIndex].text;
  //console.log(selected);
  if(selected === 'Alphabelical order'){
    ...
    //console.log(books);
    //console.log("uspelo po abcedi");
  }
  else if(selected === 'Number of pages'){
    books.sort(function(a, b) {
    ...
    //console.log(books);
    //console.log("uspelo po broju strana")
  }
  else {
    return defaultSort();
  }
...
// var sortOption1 = document.getElementById('alph');
// var sortOption2 = document.getElementById('pnmb');
