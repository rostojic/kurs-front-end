...
function addToContainer(){
  for(i=0; i<books.length; i++){
    ...
    knjiga.setAttribute("class", "book");
    ...
    knjiga.appendChild(autor);
  
    var strane = document.createElement("p");
    strane.textContent = "Broj stranica: " + books[i].pages;
    knjiga.appendChild(strane);
  }
};
...
function sort(){
  ...
  if(selectElement.value == "stranice"){
  ...
  else if (selectElement.value == "autor"){
    books.sort(function(a, b){
