var  books = [
  ...
  var sort = (function(){
    ...
    btn.onclick = function (){
      ...
      var bookSort = books.sort(function(a, b){
      ...
      var divMainContainer = document.querySelector('.book-container');
      
      divMainContainer.innerHTML = '';
      
      // books.sort(function(a,b){a.pages - b.pages});
      ...
      for(var i = 0; i < bookSort.length; i++){
        ...
        divBook.appendChild(h33);
        
        divMainContainer.appendChild(divBook);
        
        // books.pages.sort(function(a, b){return a-b});
        
        
        
        h2.textContent = bookSort[i].title;
        h3.textContent = bookSort[i].author;
        h33.textContent = bookSort[i].pages;
        img.src = bookSort[i].cover;
  ...
  var search = (function(){
    ...
    var btn = document.querySelector('#trazi');
    var divMainContainer = document.querySelector('.book-container');
  ...
  var sortByPages = (function(){

    var btn = document.getElementById('sortPage');


    btn.onclick = function (){
 
      var booksSortPage = books.sort (function sort(a, b){
    ...
    for(var i = 0; i < booksSortPage.length; i++){
      ...
      h2.textContent = booksSortPage[i].title;
      h3.textContent = booksSortPage[i].author;
      h33.textContent = booksSortPage[i].pages;
      img.src = booksSortPage[i].cover;
